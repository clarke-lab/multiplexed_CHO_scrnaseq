...
cho.combined.notag.sct <- RunUMAP(object = cho.combined.notag.sct, dims = 1:25)
```
...
# overlay library
seurat_cluster_plot_lib <- DimPlot(cho.combined.notag.sct, reduction = "umap", group.by = c("library"),pt.size = 0.5) 
# overlay cell cycle phase
seurat_cluster_plot_cc <- DimPlot(cho.combined.notag.sct, reduction = "umap", group.by = c("Phase"),pt.size = 0.5)
