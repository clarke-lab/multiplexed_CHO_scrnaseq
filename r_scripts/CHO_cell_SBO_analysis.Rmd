...
## Combine classified cell libraries
...
```{r}
bind_rows(classification_library_1, classification_library_2) %>%
  mutate(ident = case_when(
...
ElbowPlot(cho.combined.sct,ndims = 100)
