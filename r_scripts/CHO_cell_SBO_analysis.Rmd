...
qc.nCount_RNA <- isOutlier(cell_library_1$nCount_RNA, log=TRUE, type="both")
qc.nFeature_RNA  <- isOutlier(cell_library_1$nFeature_RNA, log=TRUE, type="both")
...
qc.nCount_RNA <- isOutlier(cell_library_2$nCount_RNA, log=TRUE, type="both")
qc.nFeature_RNA  <- isOutlier(cell_library_2$nFeature_RNA, log=TRUE, type="both")
